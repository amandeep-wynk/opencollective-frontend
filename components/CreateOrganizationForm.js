            ...
            <Form>
              <Container flexDirection="column" justifyContent="center" px={[1, 30, 150]} mt={4}>
                <Container display="flex" flexDirection={['column', 'row', 'row']}>
                  ...
                  >
                    ...
                    {values.name.length > 0 && !touched.slug && (
                      <P fontSize="11px">{intl.formatMessage(orgMessages.suggestedLabel)}</P>
                    )}
                    <StyledInputField
                      htmlFor="description"
                    ...
                    <P fontSize="11px">{intl.formatMessage(orgMessages.descriptionHint)}</P>
                    <StyledInputField
                      name="website"
                      htmlFor="website"
                ...
                <Flex flexDirection="column" my={4} mx={1} width={[320, 450]} color="black.800" letterSpacing="0.2px">
                  ...
                  <Flex color="black.500" alignItems="center">
                    <P fontSize="12px" fontWeight="normal" letterSpacing="0.5px" mr={2}>
                      <FormattedMessage
                        id="CreateProfile.AlreadyHaveAnAccount"
                        defaultMessage="Already have an account?"
                      />
                    </P>
                    <P fontSize="12px" fontWeight="normal" letterSpacing="0.5px">
                      <FormattedMessage
                        id="signInLink"
